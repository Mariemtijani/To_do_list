...
const [workingTaskId, setWorkingTaskId] = useState(null);
  ...
  return (
    <div className=''>
      <h3 className='all-header text-secondary p-2' style={{ width:'100px '}}>Today</h3>
      <div className="form">
      ...
      <div className="showTasks">
        {notCompletedToday.length ? (
          ...
          <div className='text-secondary fw-bold my-5'>You have no incomplete tasks today, wohoo!</div>
        )}
      </div>
