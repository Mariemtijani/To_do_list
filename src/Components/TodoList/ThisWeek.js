...
const [workingTaskId, setWorkingTaskId] = useState(null);
  ...
  return (
    <div className=''>
      <h3 className='all-header text-secondary p-2' style={{ width:'150px '}}>This Week</h3>
      <div className="form">
      ...
      <div className="showTasks">
        {notCompleted.length ? (
          ...
          <div className='text-secondary fw-bold my-5'>You have no incomplete tasks in the next 7 days, wohoo!</div>
        )}
      </div>
